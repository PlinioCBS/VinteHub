...
export default function EditProfile() {
  ...
  const handlePhotoChange = async (e) => {
    ...
    try {
      ...
      await apiFetch('/auth/profile/photo', { method: 'POST', body: form });
      await refreshUser();
        ...
        <div className="flex items-center gap-6">
          <div className="relative">
            {photoPreview ? (
              ...
              <div
                className="w-20 h-20 rounded-full flex items-center justify-center font-serif font-bold text-2xl"
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full px-4 py-3 pr-12 rounded-xl border border-gray-200 font-sans text-sm outline-none"
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full px-4 py-3 rounded-xl border border-gray-200 font-sans text-sm outline-none"
              onFocus={e => { e.target.style.borderColor = '#355641'; e.target.style.boxShadow = '0 0 0 3px #35564120'; }}
              onBlur={e => { e.target.style.borderColor = '#e5e7eb'; e.target.style.boxShadow = 'none'; }}
              disabled={loadingPassword}
            />

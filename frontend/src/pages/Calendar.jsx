...
export default function Calendar() {
  ...
  async function connectGoogle() {
    try {
      ...
      if (!url) {
        alert('Integração com Google Calendar não configurada.\n\nContate o administrador para configurar as credenciais do Google (GOOGLE_CLIENT_ID e GOOGLE_CLIENT_SECRET) no painel do Convex.');
        return;
      }
        ...
        <div className="flex items-center gap-3">
          {calStatus.connected ? (
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition-all text-sm font-medium text-gray-700 shadow-sm"
            >
